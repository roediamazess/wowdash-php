...
<html>
<head>
    <title>Test API Super Simple</title>
    <style>
...
<body>
    <h1>Test API Super Simple</h1>
    
    <button onclick="testAPI()">Test API Super Simple</button>
    <div id="result"></div>
    ...
    <script>
        async function testAPI() {
            ...
            try {
                ...
                const response = await fetch('wowdash-php/api-user-super-simple.php', {
                    method: 'POST',
                    headers: {
