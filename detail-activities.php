...
<style>
    ...
    /* Additional specificity for table elements with higher priority */
    ...
    html[data-theme=dark] .table-responsive .table thead,
    html[data-theme=dark] .table-responsive .table thead tr,
    ...
    /* Additional high specificity selectors for dark mode */
    ...
    /* Ensure card background is correct in dark mode */
    ...
    /* High specificity selectors for bordered-table in dark mode */
    html[data-theme=dark] .bordered-table {
        border-color: var(--neutral-200) !important;
    }
    ...
    html[data-theme=dark] .bordered-table tbody tr:hover td {
        background-color: var(--neutral-200) !important;
        color: var(--text-secondary-light) !important;
    }
</style>
