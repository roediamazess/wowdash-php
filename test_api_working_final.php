...
<html>
<head>
    <title>Test API Working Final</title>
    <style>
...
<body>
    <h1>Test API Working Final</h1>
    
    <button onclick="testAPI()">Test API Working</button>
    <div id="result"></div>
    ...
    <script>
        async function testAPI() {
            ...
            try {
                ...
                const response = await fetch('wowdash-php/api-user-working.php', {
                    method: 'POST',
                    headers: {
