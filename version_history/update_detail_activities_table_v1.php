<?php
// Update Detail Activities Table Structure - Version 1
// File: update_detail_activities_table_v1.php
// Date: Current working version for fixing application_id INT NULL issue
