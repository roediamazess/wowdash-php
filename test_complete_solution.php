...
<html>
<head>
    <title>Test Complete Solution</title>
...
<body>
    <div class="container">
        <h1>Test Complete Solution</h1>
        
        <div class="row">
            <div class="col-md-6">
                <h3>1. Test API Simple</h3>
                ...
                <div class="modal-body">
                    <form id="addUserForm">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="addUserId" value="AB" required>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" class="form-control" id="addUserEmail" value="mamat@powerpro.id">
                        </div>
                        <div class="mb-3">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (!saveUserBtn) {
                ...
                saveUserBtn.addEventListener('click', async function(e) {
                    ...
                    console.log('API URL:', 'wowdash-php/api-user-simple-test.php');

                    const data = await apiCall('wowdash-php/api-user-simple-test.php', userData);
                    ...
                    if (data && data.success) {
                        ...
                        modalResultDiv.innerHTML = `
                            ...
                            <pre>${JSON.stringify(data.received_data, null, 2)}</pre>
                        `;
