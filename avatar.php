...
<div class="dashboard-main-body">
    ...
    <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
        ...
        <ul class="d-flex align-items-center gap-2">
            ...
            <li>-</li>
            <li class="fw-medium">Components / Avatars</li>
        </ul>
    </div>
            ...
            <div class="card p-0 overflow-hidden position-relative radius-12">
                ...
                <div class="card-body p-24">
                    <div class="d-flex align-items-center flex-wrap gap-3">
                        <img src="assets/images/avatar/avatar1.png" class="w-24-px h-24-px rounded-circle object-fit-cover" alt="Avatar">
                        <img src="assets/images/avatar/avatar1.png" class="w-32-px h-32-px rounded-circle object-fit-cover" alt="Avatar">
                        <img src="assets/images/avatar/avatar1.png" class="w-40-px h-40-px rounded-circle object-fit-cover" alt="Avatar">
                        <img src="assets/images/avatar/avatar1.png" class="w-44-px h-44-px rounded-circle object-fit-cover" alt="Avatar">
                        <img src="assets/images/avatar/avatar1.png" class="w-56-px h-56-px rounded-circle object-fit-cover" alt="Avatar">
                        <img src="assets/images/avatar/avatar1.png" class="w-64-px h-64-px rounded-circle object-fit-cover" alt="Avatar">
                        <img src="assets/images/avatar/avatar1.png" class="w-72-px h-72-px rounded-circle object-fit-cover" alt="Avatar">
                        <img src="assets/images/avatar/avatar1.png" class="w-80-px h-80-px rounded-circle object-fit-cover" alt="Avatar">
                    </div>
                    <div class="d-flex align-items-center flex-wrap gap-3 mt-24">
                        <img src="assets/images/avatar/avatar2.png" class="w-24-px h-24-px radius-8 object-fit-cover" alt="Avatar">
                        <img src="assets/images/avatar/avatar2.png" class="w-32-px h-32-px radius-8 object-fit-cover" alt="Avatar">
                        <img src="assets/images/avatar/avatar2.png" class="w-40-px h-40-px radius-8 object-fit-cover" alt="Avatar">
                        <img src="assets/images/avatar/avatar2.png" class="w-44-px h-44-px radius-8 object-fit-cover" alt="Avatar">
                        <img src="assets/images/avatar/avatar2.png" class="w-56-px h-56-px radius-8 object-fit-cover" alt="Avatar">
                        <img src="assets/images/avatar/avatar2.png" class="w-64-px h-64-px radius-8 object-fit-cover" alt="Avatar">
                        <img src="assets/images/avatar/avatar2.png" class="w-72-px h-72-px radius-8 object-fit-cover" alt="Avatar">
                        <img src="assets/images/avatar/avatar2.png" class="w-80-px h-80-px radius-8 object-fit-cover" alt="Avatar">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card p-0 overflow-hidden position-relative radius-12">
                ...
                <div class="card-body p-24">
                    <div class="d-flex align-items-center flex-wrap justify-content-between gap-3">
                        <img src="assets/images/avatar/avatar-shape1.png" alt="" class="w-120-px h-120-px radius-8 object-fit-cover">
                        <img src="assets/images/avatar/avatar-shape2.png" alt="" class="w-120-px h-120-px rounded-circle object-fit-cover">
                        <img src="assets/images/avatar/avatar-shape3.png" alt="" class="w-auto h-120-px  object-fit-cover">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card-body p-24">
                    <div class="d-flex align-items-center flex-wrap gap-3">
                        <div class="position-relative">
                            <img src="assets/images/avatar/status-avatar.png" class="w-24-px h-24-px rounded-circle object-fit-cover" alt="Avatar">
                            <span class="w-8-px h-8-px bg-primary-600 border br-white rounded-circle position-absolute end-0 bottom-3px"></span>
                        </div>
                        <div class="position-relative">
                            <img src="assets/images/avatar/status-avatar.png" class="w-32-px h-32-px rounded-circle object-fit-cover" alt="Avatar">
                            <span class="w-8-px h-8-px bg-primary-600 border br-white rounded-circle position-absolute end-0 bottom-3px"></span>
                        </div>
                        <div class="position-relative">
                            <img src="assets/images/avatar/status-avatar.png" class="w-40-px h-40-px rounded-circle object-fit-cover" alt="Avatar">
                            <span class="w-8-px h-8-px bg-primary-600 border br-white rounded-circle position-absolute end-0 bottom-3px"></span>
                        </div>
                        <div class="position-relative">
                            <img src="assets/images/avatar/status-avatar.png" class="w-44-px h-44-px rounded-circle object-fit-cover" alt="Avatar">
                            <span class="w-8-px h-8-px bg-primary-600 border br-white rounded-circle position-absolute end-0 bottom-3px"></span>
                        </div>
                    </div>
                    <div class="d-flex align-items-center flex-wrap gap-3 mt-24">
            ...
            <div class="card p-0 overflow-hidden position-relative radius-12 h-100">
                ...
                <div class="card-body p-24">
                    <div class="d-flex align-items-center flex-wrap">
                        <img src="assets/images/avatar/avatar-group1.png" alt="" class="w-24-px h-24-px rounded-circle object-fit-cover position-relative">
                        <img src="assets/images/avatar/avatar-group2.png" alt="" class="w-24-px h-24-px rounded-circle object-fit-cover position-relative ms--10px">
                        <img src="assets/images/avatar/avatar-group3.png" alt="" class="w-24-px h-24-px rounded-circle object-fit-cover position-relative ms--10px">
                        <img src="assets/images/avatar/avatar-group4.png" alt="" class="w-24-px h-24-px rounded-circle object-fit-cover position-relative ms--10px">
                        <img src="assets/images/avatar/avatar-group5.png" alt="" class="w-24-px h-24-px rounded-circle object-fit-cover position-relative ms--10px">
                        <img src="assets/images/avatar/avatar-group6.png" alt="" class="w-24-px h-24-px rounded-circle object-fit-cover position-relative ms--10px">
                        <img src="assets/images/avatar/avatar-group6.png" alt="" class="w-24-px h-24-px rounded-circle object-fit-cover position-relative ms--10px">
                    ...
                    <div class="d-flex align-items-center flex-wrap mt-24">
                        <img src="assets/images/avatar/avatar-group1.png" alt="" class="w-32-px h-32-px rounded-circle object-fit-cover position-relative">
                        <img src="assets/images/avatar/avatar-group2.png" alt="" class="w-32-px h-32-px rounded-circle object-fit-cover position-relative ms--10px">
                        <img src="assets/images/avatar/avatar-group3.png" alt="" class="w-32-px h-32-px rounded-circle object-fit-cover position-relative ms--10px">
                        <img src="assets/images/avatar/avatar-group4.png" alt="" class="w-32-px h-32-px rounded-circle object-fit-cover position-relative ms--10px">
                        <img src="assets/images/avatar/avatar-group5.png" alt="" class="w-32-px h-32-px rounded-circle object-fit-cover position-relative ms--10px">
                        <img src="assets/images/avatar/avatar-group6.png" alt="" class="w-32-px h-32-px rounded-circle object-fit-cover position-relative ms--10px">
                        <img src="assets/images/avatar/avatar-group6.png" alt="" class="w-32-px h-32-px rounded-circle object-fit-cover position-relative ms--10px">
                    ...
                    <div class="row gy-3">
                        <div class="col-sm-6">
                            <div class="d-flex align-items-center gap-2">
                                <img src="assets/images/avatar/avatar1.png" alt="" class="w-32-px h-32-px rounded-circle object-fit-cover flex-shrink-0">
                        ...
                        <div class="col-sm-6">
                            <div class="d-flex align-items-center gap-2">
                                <img src="assets/images/avatar/avatar2.png" alt="" class="w-32-px h-32-px rounded-circle object-fit-cover flex-shrink-0">
                                <div class="flex-grow-1 d-inline-flex flex-column">
